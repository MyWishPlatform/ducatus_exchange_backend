...
class StatisticsTransfer(models.Model):
    ...
    address_from = models.ForeignKey(StatisticsAddress, on_delete=models.CASCADE, related_name='address_from', null=True, default=None)
    address_to = models.ForeignKey(StatisticsAddress, on_delete=models.CASCADE, related_name='address_to', null=True, default=None)
